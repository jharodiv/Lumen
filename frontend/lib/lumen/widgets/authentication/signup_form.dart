...
class SignupForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: LayoutBuilder(
        // Use LayoutBuilder to adjust the layout based on screen size
        builder: (context, constraints) {
          double width = constraints.maxWidth;

          return SizedBox(
            width: width *
                0.8, // Adjust the width dynamically based on screen size
            child: Padding(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            softWrap:
                                true, // Ensures the text wraps onto the next line
                          ),
                        ),
                      ],
                    ),
